...
func _init() -> void:
	push_error("[stub] DamageCalculator instantiated but not implemented — fill src/systems/DamageCalculator.gd")
	assert(false, "DamageCalculator is a stub — implement before instantiation")
