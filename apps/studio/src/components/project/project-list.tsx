...
export function ProjectList({ projects, selectedProjectId, loading, onSelect }: ProjectListProps): JSX.Element {
  return (
    <Card className="p-4">
      ...
      <div className="space-y-2">
        ...
        {!loading && projects.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-border bg-background/20 p-4 text-sm text-muted-foreground">
            No projects yet. Start a conversation to scaffold your first game.
          </div>
        ) : null}
        {!loading
